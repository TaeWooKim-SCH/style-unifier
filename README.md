...
**Style Unifier는 이 문제를 해결합니다.** 기준이 되는 reference 이미지 한 장을 주면, 나머지 에셋들의 스타일을 그 기준으로 자동 변환합니다. **디자인은 그대로 보존**한 채 스타일만 이식합니다.
...
| 인코딩 | Cross-Attention Conditioning   | Multi-reference pooling    |
| 생성   | Conditional Diffusion Sampling | SDXL + Animagine-XL-3.1    |
| 생성   | Spatial Conditioning           | ControlNet (lineart)       |
